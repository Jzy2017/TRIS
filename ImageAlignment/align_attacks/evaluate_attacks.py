...
parser.add_argument('--model-path',
                    default='./model-cifar-wideResNet/GN-us1_batch64_lr0.01_lrG0.001_epochs90_optG momentum_opt_model momentum_momentum0.9_weightdecay0.0002_beta1_G0.5-model-90.pt',
...
parser.add_argument('--adapt_model-path',
                    default='./adapt_model-cifar-wideResNet/adapt_model-wideres-epoch76.pt',
                    help='adapt_model for white-box attack evaluation')
parser.add_argument('--source-adapt_model-path',
                    default='./checkpoints/model_cifar_wrn.pt',
                    help='source adapt_model for black-box attack evaluation')
parser.add_argument('--target-adapt_model-path',
                    default='./checkpoints/model_cifar_wrn.pt',
                    help='target adapt_model for black-box attack evaluation')
...
def eval_adv_test_whitebox(model, device, test_loader, attack_method):
    """
    evaluate adapt_model by white-box attack
    """
    model.eval()
    robust_err_total = 0
    natural_err_total = 0
...
def eval_adv_test_blackbox(model_target, model_source, device, test_loader, attack_method):
    """
    evaluate adapt_model by black-box attack
    """
    model_target.eval()
    model_source.eval()
    robust_err_total = 0
