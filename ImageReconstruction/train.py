...
if device!='cpu':
    ...
    use_cuda=False
nz = 200
data_root='../output_COCO_256/adversarial_train/Ours/clean/'
...
for epoch in range(1,250):
    ...
    if epoch % 2 == 0:
        if not os.path.exists('coco/snapshot_Darts_630/'):
            os.makedirs('coco/snapshot_Darts_630/')
        torch.save(netG.state_dict(), 'coco/snapshot_Darts_630/' + str(epoch) + "_G.pkl")
