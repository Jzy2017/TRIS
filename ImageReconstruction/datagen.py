...
raw_image_path = 'E:/yan1/多模态配准/multimodal-stitching-pytorch/data/cocoval/val2014'
box_size = 128
height = 360
width = 480
overlap_rate = 0.5
...
dataset_size = count_files_in_directory(raw_image_path)
generate_image_path = 'E:/yan1/多模态配准/multimodal-stitching-pytorch/data/cocoval/training_1'
generate_dataset(raw_image_path, generate_image_path, rho, height, width, dataset_size, box_size, overlap_rate)
"""
### generate testing dataset
print("Testing dataset...")
dataset_size = 1000
generate_image_path = 'E:/yan1/多模态配准/multimodal-stitching-pytorch/data/cocoval/testing'
generate_dataset(raw_image_path, generate_image_path, rho, height, width, dataset_size, box_size, overlap_rate)
"""
